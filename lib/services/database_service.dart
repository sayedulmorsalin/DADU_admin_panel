...
class DatabaseService {
  ...
  Future<List<Map<String, dynamic>>> getAllCancelled() async => _getOrders('cancelled');
  ...
  Stream<int> getCancelledCountStream() => _db.collection('users').where('cancelled', isGreaterThan: []).snapshots().map((s) => s.size);
